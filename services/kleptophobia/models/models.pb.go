...
func (x *GetPublicInfoRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_models_models_proto_rawDesc = []byte{
	...
	0x14, 0x47, 0x65, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65,
	...
	0x07, 0x5f, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x22, 0x5c, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69,
	...
	,
...
var file_models_models_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_models_models_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_models_models_proto_goTypes = []interface{}{
	(GetPublicInfoReply_Status)(0), // 0: models.GetPublicInfoReply.Status
	(RegisterReply_Status)(0),      // 1: models.RegisterReply.Status
	(*GetPublicInfoRequest)(nil),   // 2: models.GetPublicInfoRequest
	(*GetPublicInfoReply)(nil),     // 3: models.GetPublicInfoReply
	(*RegisterRequest)(nil),        // 4: models.RegisterRequest
	(*RegisterReply)(nil),          // 5: models.RegisterReply
	(*PrivatePerson)(nil),          // 6: models.PrivatePerson
	(*PublicPerson)(nil),           // 7: models.PublicPerson
}
var file_models_models_proto_depIdxs = []int32{
	...
	7, // 1: models.GetPublicInfoReply.person:type_name -> models.PublicPerson
	6, // 2: models.RegisterRequest.person:type_name -> models.PrivatePerson
	1, // 3: models.RegisterReply.status:type_name -> models.RegisterReply.Status
	4, // 4: models.Kleptophobia.Register:input_type -> models.RegisterRequest
	2, // 5: models.Kleptophobia.GetPublicInfo:input_type -> models.GetPublicInfoRequest
	5, // 6: models.Kleptophobia.Register:output_type -> models.RegisterReply
	3, // 7: models.Kleptophobia.GetPublicInfo:output_type -> models.GetPublicInfoReply
